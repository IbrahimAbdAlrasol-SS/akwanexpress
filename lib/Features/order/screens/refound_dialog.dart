...
class RefoundDialog extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<RefoundDialog> createState() => _RefoundDialogState();
}

class _RefoundDialogState extends ConsumerState<RefoundDialog> {
                          ...
                          onPressed: !fromWarehouse
                              ? () async {
                                  ...
                                  if (result.$1 != null) {
                                    GlobalToast.show(
                                      context: context,
                                      message: 'تم تاكيد تسليمك للطلبات',
